  ...
  if(MSVC)
    ...
    if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
      if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 5.0)
        set(ADDL_WARNING_FLAGS "${ADDL_WARNING_FLAGS} -Wno-deprecated")
      endif()
      if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 7.0)
        set(ADDL_WARNING_FLAGS "${ADDL_WARNING_FLAGS} -Wno-ignored-attributes -Wno-int-in-bool-context -Wno-misleading-indentation")
      endif()
    endif()

    set(CMAKE_C_FLAGS_DEBUG            "${CMAKE_C_FLAGS_DEBUG} -fno-inline -Wall ${ADDL_WARNING_FLAGS}" CACHE STRING "Flags used by the compiler during debug builds." FORCE)
    set(CMAKE_CXX_FLAGS_DEBUG          "${CMAKE_CXX_FLAGS_DEBUG} -fno-inline -Wall ${ADDL_WARNING_FLAGS}" CACHE STRING "Flags used by the compiler during debug builds." FORCE)
    set(CMAKE_C_FLAGS_RELWITHDEBINFO   "-g -O3 -Wall -march=native -DNDEBUG ${ADDL_WARNING_FLAGS}" CACHE STRING "Flags used by the compiler during relwithdebinfo builds." FORCE)
    set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-g -O3 -Wall -march=native -DNDEBUG ${ADDL_WARNING_FLAGS}" CACHE STRING "Flags used by the compiler during relwithdebinfo builds." FORCE)
    set(CMAKE_C_FLAGS_RELEASE          "-O3 -Wall -DNDEBUG -Wall -march=native ${ADDL_WARNING_FLAGS}" CACHE STRING "Flags used by the compiler during release builds." FORCE)
    set(CMAKE_CXX_FLAGS_RELEASE        "-O3 -Wall -DNDEBUG -Wall -march=native ${ADDL_WARNING_FLAGS}" CACHE STRING "Flags used by the compiler during release builds." FORCE)
    set(CMAKE_C_FLAGS_TIMING           "${CMAKE_C_FLAGS_RELEASE} -DENABLE_TIMING" CACHE STRING "Flags used by the compiler during timing builds." FORCE)
    set(CMAKE_CXX_FLAGS_TIMING         "${CMAKE_CXX_FLAGS_RELEASE} -DENABLE_TIMING" CACHE STRING "Flags used by the compiler during timing builds." FORCE)
    set(CMAKE_EXE_LINKER_FLAGS_TIMING  "${CMAKE_EXE_LINKER_FLAGS_RELEASE}" CACHE STRING "Linker flags during timing builds." FORCE)
    ...
    set(CMAKE_C_FLAGS_PROFILING        "-g -O3 -Wall -march=native -DNDEBUG" CACHE STRING "Flags used by the compiler during profiling builds." FORCE)
    set(CMAKE_CXX_FLAGS_PROFILING      "-g -O3 -Wall -march=native -DNDEBUG" CACHE STRING "Flags used by the compiler during profiling builds." FORCE)
    set(CMAKE_EXE_LINKER_FLAGS_PROFILING "${CMAKE_EXE_LINKER_FLAGS_RELEASE}" CACHE STRING "Linker flags during profiling builds." FORCE)
